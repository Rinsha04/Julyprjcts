...
public class Ebayeloctronic {
	...
	public void test1() {
		...
		// implicitwait:-driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
	WebElement mouseover=	driver.findElement(By.xpath("//*[@id=\"mainContent\"]/div[1]/ul/li[3]/a"));
